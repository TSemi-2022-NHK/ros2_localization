...
: ${AMENT_CURRENT_PREFIX:="/home/kazuma/ros2_ws2/install/local"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/local/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/local/environment/path.sh"
